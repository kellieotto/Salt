...
Next, we predict change in life expectancy using per capita GDP and ETOH consumption. We look at the correlation between the residuals (predicted - actual change in life expectancy) and change in sodium consumption.
...
Finally, we predict change in life expectancy using per capita GDP, ETOH consumption, and annual cigarettes per capita. We look at the correlation between the residuals (predicted - actual change in life expectancy) and change in sodium consumption.
...
Next, we predict life expectancy using ETOH consumption and per capita GDP. We look at the correlation between the residuals (predicted - actual life expectancy) and sodium consumption.
...
Finally, we predict life expectancy using per capita GDP, ETOH consumption, annual cigarettes per capita. We look at the correlation between the residuals (predicted - actual life expectancy) and sodium consumption.
