...
Next, we predict change in life expectancy using per capita GDP and alcohol consumption. We look at the correlation between the residuals (predicted - actual change in life expectancy) and change in tobacco consumption.
...
Finally, we predict change in life expectancy using per capita GDP, Na+ consumption, and alcohol consumption. We look at the correlation between the residuals (predicted - actual change in life expectancy) and change in alcohol consumption.
...
Next, we predict life expectancy using alcohol consumption and per capita GDP. We look at the correlation between the residuals (predicted - actual life expectancy) and alcohol consumption.
...
Finally, we predict life expectancy using per capita GDP, sodium consumption, and alcohol consumption. We look at the correlation between the residuals (predicted - actual life expectancy) and alcohol consumption.
