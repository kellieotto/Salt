...
Next, we predict change in life expectancy using per capita GDP and sodium consumption. We look at the correlation between excess mortality (predicted - actual change in life expectancy) and change in alcohol consumption.
...
Finally, we predict change in life expectancy using per capita GDP, Na+ consumption, and annual cigarettes per capita. We look at the correlation between excess mortality (predicted - actual change in life expectancy) and change in alcohol consumption.
...
Next, we predict life expectancy using sodium consumption and per capita GDP. We look at the correlation between excess mortality (predicted - actual life expectancy) and alcohol consumption.
...
Finally, we predict life expectancy using per capita GDP, sodium consumption, and annual cigarettes per capita. We look at the correlation between excess mortality (predicted - actual life expectancy) and alcohol consumption.
